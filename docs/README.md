...
The gateway currently hosts models from Swiss AI, AISingapore, Allen AI, SpeakLeash, Utter Project, and other partners. Developers access all models through a single OpenAI-compatible API at `api.publicai.co`.
